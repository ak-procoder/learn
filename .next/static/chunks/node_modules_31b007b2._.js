...
function Fade() {
    ...
    function getSlideTransform(position) {
        ...
        return "translate".concat(translateAxis, "(").concat(axis.direction(position), "px)");
    }
    function disableScroll() {
        const { translate, slideLooper } = emblaApi.internalEngine();
        translate.clear();
        translate.toggleActive(false);
        slideLooper.loopPoints.forEach((param)=>{
            let { translate } = param;
            translate.clear();
            translate.toggleActive(false);
        });
...
//# sourceMappingURL=node_modules_31b007b2._.js.map